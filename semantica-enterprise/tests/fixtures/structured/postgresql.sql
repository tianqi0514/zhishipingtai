...
-- 不代表国联集团真实经营数据。该数据集与上方销售验收数据共存，
-- 便于同一套只读数据库同时验证经营问答和采购场景。
...
INSERT INTO companies VALUES
  (10, '国联集团（演示）', '华东', '演示集团主体，不代表真实经营数据', '2026-01-01T08:00:00+08:00'),
  (11, '集团本部（演示）', '华东', '演示集团本部', '2026-01-01T08:00:00+08:00'),
  (12, '数字科技公司（演示）', '华东', '演示数字化建设单位', '2026-01-01T08:00:00+08:00'),
  (13, '能源服务公司（演示）', '华东', '演示能源服务单位', '2026-01-01T08:00:00+08:00'),
  (14, '金融科技公司（演示）', '华东', '演示金融科技单位', '2026-01-01T08:00:00+08:00');
...
INSERT INTO products VALUES
  (101, 'DEMO-NX1', 'NexusOne', '智慧流程组件', 120000.00, '{"demo":true,"edition":"enterprise"}', '智慧流程中枢核心产品'),
  (102, 'DEMO-WF', '智慧流程引擎', '流程平台', 180000.00, '{"demo":true}', '集团流程编排引擎'),
  (103, 'DEMO-DEX', '集团数据交换平台', '数据平台', 420000.00, '{"demo":true}', '集团系统间数据交换能力'),
  (104, 'DEMO-IAM', '统一身份组件', '基础组件', 300000.00, '{"demo":true}', '统一身份认证组件');
...
INSERT INTO project_products VALUES
  (101, 101, '核心流程能力', '2026-01-10'),
  (101, 102, '流程编排', '2026-01-10'),
  (101, 103, '数据交换', '2026-01-10'),
  (101, 104, '统一身份', '2026-01-10'),
  (102, 101, '知识服务接入', '2026-02-10'),
  (102, 103, '数据交换', '2026-02-10'),
...
COMMENT ON COLUMN purchase_orders.amount IS '采购订单含税金额；有效口径排除 cancelled 和 draft';
INSERT INTO purchase_orders VALUES
  (1001, 'PO-DEMO-2026-001', 3, 101, 101, '2026-01-15', 'signed', 360000.00, 'CNY', '2026-01-14T10:00:00+08:00', NULL, '智慧流程中枢首批组件', '{"demo":true,"source":"contract"}'),
  (1002, 'PO-DEMO-2026-002', 3, 101, 101, '2026-02-15', 'executing', 240000.00, 'CNY', '2026-02-14T15:00:00+08:00', '2026-02-16T09:00:00+08:00', 'NexusOne 第二批组件', '{"demo":true}'),
  (1003, 'PO-DEMO-2026-003', 2, 102, 103, '2026-03-11', 'signed', 420000.00, 'CNY', '2026-03-10T15:00:00+08:00', NULL, '集团数据交换平台采购', '{"demo":true}'),
  (1004, 'PO-DEMO-2026-004', 4, 103, 102, '2026-04-09', 'accepted', 380000.00, 'CNY', '2026-04-08T10:00:00+08:00', '2026-04-10T08:00:00+08:00', '知识底座与流程服务采购', '{"demo":true}'),
  (1005, 'PO-DEMO-2026-005', 5, 104, 101, '2026-05-20', 'accepted', 300000.00, 'CNY', '2026-05-19T10:00:00+08:00', '2026-05-21T08:00:00+08:00', '统一身份组件采购', '{"demo":true}'),
  (1006, 'PO-DEMO-2026-006', 2, 101, 101, '2026-05-28', 'cancelled', 120000.00, 'CNY', NULL, NULL, '因供应风险取消', '{"demo":true,"cancel_reason":"交付延期"}'),
  (1007, 'PO-DEMO-2026-007', 3, 105, 102, '2026-06-05', 'executing', 90000.00, 'CNY', NULL, '2026-06-06T08:00:00+08:00', '已执行但审批待补充', '{"demo":true,"exception":true}'),
  (1009, 'PO-DEMO-2025-001', 3, 101, 101, '2025-06-10', 'accepted', 200000.00, 'CNY', '2025-06-09T10:00:00+08:00', '2025-06-11T08:00:00+08:00', '同比基期订单', '{"demo":true}'),
  (1011, 'PO-DEMO-2027-001', 3, 103, 102, '2027-01-01', 'accepted', 60000.00, 'CNY', '2026-12-31T17:00:00+08:00', '2027-01-02T08:00:00+08:00', '下一年度订单', '{"demo":true}');
...
INSERT INTO purchase_order_items VALUES
  (1, 1001, 101, 2, 120000.00, 240000.00),
  (2, 1001, 102, 1, 120000.00, 120000.00),
  (3, 1002, 101, 2, 120000.00, 240000.00),
  (4, 1003, 103, 1, 420000.00, 420000.00),
  (5, 1004, 102, 1, 380000.00, 380000.00),
  (6, 1005, 104, 1, 300000.00, 300000.00),
  (7, 1006, 101, 1, 120000.00, 120000.00),
  (8, 1007, 102, 1, 90000.00, 90000.00),
  (10, 1009, 101, 1, 200000.00, 200000.00),
  (12, 1011, 103, 1, 60000.00, 60000.00);
...
INSERT INTO approval_records VALUES
  (1, 1001, '采购审批', '集团采购管理部', 'approved', '2026-01-14T10:00:00+08:00', '审批通过'),
  (2, 1002, '采购审批', '数字化管理部', 'approved', '2026-02-14T15:00:00+08:00', '审批通过'),
  (3, 1003, '采购审批', '集团采购管理部', 'approved', '2026-03-10T15:00:00+08:00', '审批通过'),
  (4, 1004, '采购审批', '能源服务公司', 'approved', '2026-04-08T10:00:00+08:00', '审批通过'),
  (5, 1005, '采购审批', '金融科技公司', 'approved', '2026-05-19T10:00:00+08:00', '审批通过'),
...
INSERT INTO system_dependencies VALUES
  (1, '智慧流程中枢', '集团数据交换平台', '数据交换服务', 'data', '数字化管理部', 'active', '{"demo":true}'),
  (2, '集团数据交换平台', '统一身份组件', '统一身份组件', 'identity', '数字化管理部', 'maintenance', '{"demo":true,"maintenance_window":"2026-09-18 22:00"}'),
  (3, '智慧流程中枢', 'NexusOne', '语义建模与知识服务', 'knowledge', '项目管理办公室', 'active', '{"demo":true}');
...
CREATE TABLE policy_applicability (
  ...
  UNIQUE (policy_code, org_unit_id, effective_date)
);
